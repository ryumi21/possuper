...
@section('title', 'Tri Fusion - Products')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <button type="button" data-bs-toggle="modal" data-bs-target="#createProductModal"
                class="btn text-white fw-bold d-flex align-items-center px-3 py-2"
                style="font-size: 0.85rem; border-radius: 8px; background-color: var(--theme-orange); border: none;">
        ...
        <div class="modal-content border-0 shadow" style="border-radius: 12px;">
            ...
            <div class="modal-body p-4">
                <form id="productForm">
                    ...
                    {{-- ===== PRODUCT DETAIL / MATERIAL SECTION ===== --}}
                    <div class="mt-4">
                    ...
                    <div class="col-12 mt-4 text-end">
                        ...
                        <button type="submit" class="btn text-white fw-bold px-4 py-2"
                            style="background-color: var(--theme-orange); border-radius: 8px;">
                            Save Product
                        </button>
                    </div>
                </form>
...
{{-- Hidden template for a single material row --}}
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    function fetchProducts() {
        fetch(apiBase)
            ...
            .then(res => {
                ...
                products.forEach(p => {
                    ...
                    row.innerHTML = `
                        ...
                        <td><span class="badge bg-light text-secondary fw-semibold"
                                style="font-size:0.75rem; padding:4px 8px; border-radius:6px;">
                                ${p.Type || '-'}
                            </span></td>
                        ...
                        <td class="text-end pe-4">
                            <div class="d-flex justify-content-end gap-2">
                                <button class="premium-btn-icon btn-edit" data-id="${p.Oid}" title="Edit">
                                    <i class="bi bi-pencil text-warning"></i>
                                </button>
                                <button class="premium-btn-icon delete-btn btn-delete" data-id="${p.Oid}" title="Delete">
            ...
            .catch(() => {
                tbody.innerHTML = '<tr><td colspan="8" class="text-center py-4 text-danger">Failed to fetch data.</td></tr>';
            });
    }
...
<style>
    ...
    .premium-table-grid tbody tr { transition: background-color 0.2s ease; }
    .premium-table-grid tbody tr:hover { background-color: rgba(255,159,67,0.02) !important; }
    ...
    .premium-btn-icon.delete-btn:hover i { color: #dc2626 !important; }
